...
set :application_name, 'jarvis'
set :domain, 'jarvis-do'
set :user, fetch(:application_name)
set :deploy_to, "/home/#{fetch(:user)}/app"
set :repository, 'https://github.com/jarvisjohnson/jarvis.git'
set :branch, 'master'
set :rvm_use_path, '/etc/profile.d/rvm.sh'
set :app_root,   '/Users/swish/Dev/jarvis'   # Local path to application
